...
var controller = (function ($, window, document) {
    ...
    function initWxJSSDK() {
        var thisPageUrl = locationSelf.href;
        // var latitude=locache.session.get("latitude");
        // var longitude=locache.session.get("longitude");//如果存在就
    ...
    wx.ready(function () {
        ...
        wx.getLocation({
            ...
            success: function (res) {
                ...
                // locache.session.set("latitude",latitude);
                // locache.session.set("longitude",longitude);
                return locationAjax(res.longitude,res.latitude);//将地理位置信息给后台
            }
        });
    ...
    //将地理位置信息给后台
    function locationAjax(longitude,latitude) {
