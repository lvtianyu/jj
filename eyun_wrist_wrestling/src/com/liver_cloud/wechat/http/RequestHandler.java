...
import com.liver_cloud.wechat.util.TenpayUtil;
...
public class RequestHandler {
	...
	public String createSign(SortedMap<String, String> packageParams) {
		...
		String sign = MD5Util.getMD5(sb.toString(), this.charset).toUpperCase();
	...
	public boolean createMd5Sign(String signParams) {
		...
		String sign = MD5Util.getMD5(sb.toString(), enc).toLowerCase();
